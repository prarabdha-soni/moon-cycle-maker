...
import { Play, Clock, Sparkles, Wind, Scale, Dumbbell, ChevronRight, Flame } from "lucide-react";
                  ...
                  return (
                    <div key={v.id} className="shrink-0 w-[200px] rounded-2xl overflow-hidden border border-border bg-card">
                      ...
                      <div className={cn("relative h-[112px] bg-gradient-to-br flex items-center justify-center", v.gradient)}>
                        <button className="grid size-12 place-items-center rounded-full bg-white/25 backdrop-blur-sm border border-white/30 transition-all hover:bg-white/35 active:scale-95">
